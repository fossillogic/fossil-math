...
namespace fossil {
    ...
    namespace math {
        ...
        public:
             ...
             * @return The dot product as a double.
             * @throws std::invalid_argument if vectors are not the same length.
             */
             ...
             * @param A First matrix as a flat vector (row-major).
             * @param rowsA Number of rows in A.
             * @param colsA Number of columns in A.
             * @param B Second matrix as a flat vector (row-major).
             * @param rowsB Number of rows in B.
             * @param colsB Number of columns in B.
             * @return Resulting matrix as a flat vector (row-major).
             ...
             * @param A Input matrix as a flat vector (row-major).
             * @param rows Number of rows in A.
             * @param cols Number of columns in A.
             * @return Transposed matrix as a flat vector (row-major).
             ...
             * @return Identity matrix as a flat vector (row-major).
             ...
             * @param M Input matrix as a flat vector (row-major).
             * @param n Size of the matrix (n x n).
             ...
             * @param M Input matrix as a flat vector (row-major).
             * @param n Size of the matrix (n x n).
             * @return Inverse matrix as a flat vector (row-major).
             ...
             * @param coeffs Coefficients of the polynomial (coeff[0] is constant term).
            ...
            /**
             * Computes the derivative of a polynomial.
             * @param coeffs Coefficients of the original polynomial.
             ...
             * @param A Coefficient matrix (n x n) as a flat vector (row-major).
             ...
             * @param b Coefficient of x.
             * @param c Constant term.
             * @return std::vector<double> containing the real roots.
             * @throws std::runtime_error if no real roots exist.
             */
            static std::vector<double> solve_quadratic(double a, double b, double c) {

...
class FossilMathConan(ConanFile):
    name = "fossil_math"
    version = "0.1.1"
    license = "MPL-2.0"
    author = "Fossil Logic <michaelbrockus@gmail.com>"
    url = "https://github.com/fossillogic/fossil-math"
    description = "Fossil Math is a lightweight, cross-platform mathematics library written in pure C with zero external dependencies."
    topics = ("c", "algebra", "trigonometry", "math", "cpp", "meson", "conan-recipe", "mesonbuild", "ninja-build")
    ...
    def package(self):
        ...
        copy(self, "*.h",
             src="code/logic/fossil/math",
             dst=os.path.join(self.package_folder, "include", "fossil", "math"))

    def package_info(self):
        """Set information for consumers of the package"""
        self.cpp_info.libs = ["fossil_math"]
